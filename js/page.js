...
function langchange() {
    if(document.getElementById("lang").value=="1") {
        ...
        document.getElementById("footer").innerHTML = "<span style='text-align: center; display:block; '>Quinn-Web 12 语言设置目前仅支持各个独立页面，无法实现跨页面语言统一。我们正在尝试通过创建单独的页面来实现设置的语言统一，就像 Quinn-Web v1.0 一样。<br />由于技术原因，Quinn-Web 12 不能像 <a href='/web_history/v10.0' target='_blank'>Quinn-Web v10.0</a> 一样很好地适应手机。我们正着力于解决这个问题。<br />100% 由人工翻译，若发现有错误或翻译遗漏，建议你访问英文页面，尽请谅解！<hr />📅 最近更新：2022年7月2日 | Copyright © 2019-" + new Date(Date.parse(new Date())).getFullYear() + " Quinn0823 保留所有权利。</span>";
    }
}