# Apple Siri 语音导航 <Badge type="info" text="Voice Navigation" /> {#apple-siri-voice-navigation}
...
**与 Siri 一起体验道路！** Apple Siri 语音导航将 Apple OS 中的标志性声音带入卡车模拟游戏。有 **24 种语言的 90 多种声音**可供选择，Siri 将为你的卡车冒险提供指引，让你的旅程更加愉快和难忘。
